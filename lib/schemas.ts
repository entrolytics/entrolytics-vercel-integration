...
export const billingPlanSchema = z.object({
  ...
  highlightedDetails: z.array(z.object({
    label: z.string(),
    value: z.string().optional(),
  })).optional(),
...
export type InstallIntegrationRequest = z.infer<typeof installIntegrationRequestSchema>;
...
export type ProvisionResourceRequest = z.infer<typeof provisionResourceRequestSchema>;
