...
function DashboardContent() {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      // Ignore for now: dashboard remains in empty-state when loading fails.
    }
  };
      ...
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Entrolytics Dashboard</h1>
                <p className="text-sm text-gray-500">Manage your analytics resources</p>
              </div>
            </div>
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
          ...
          <p className="mt-2 text-sm text-green-700">
            Your Vercel account is connected to Entrolytics. Create resources to start tracking
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border">
              <div className="p-6 border-b flex items-center justify-between">
                <div>
                  <h2 className="text-lg font-semibold text-gray-900">Analytics Resources</h2>
              ...
              <div className="p-6">
                {showCreateForm && (
                  <div className="mb-6 p-4 bg-gray-50 rounded-lg border">
                    <h3 className="font-medium text-gray-900 mb-4">Create New Resource</h3>
                      ...
                      >
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-500 mt-1">
                              Website ID: {resource.metadata?.websiteId || "N/A"}
                            </p>
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6">
              ...
              <div className="space-y-4">
                <div className="flex gap-3">
                  ...
                  <div className="flex-1">
                    <h3 className="font-medium text-gray-900">Create a Resource</h3>
                    <p className="text-sm text-gray-600 mt-1">
                      Create an analytics resource and link it to a Vercel project. Environment
                      variables will be automatically injected.
                    </p>
                  </div>
                </div>
                <div className="flex gap-3">
                  ...
                  <div className="flex-1">
                    <h3 className="font-medium text-gray-900">Add Tracking Script</h3>
                    <p className="text-sm text-gray-600 mt-1">
...
/>`}
                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex-1">
                    <h3 className="font-medium text-gray-900">Deploy & Track</h3>
                    <p className="text-sm text-gray-600 mt-1">
                      Deploy your project and start seeing analytics data in real-time!
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6">
              <h3 className="font-semibold text-gray-900 mb-4">Auto-Configured Variables</h3>
              ...
              <p className="mt-3 text-xs text-gray-500">
                These variables are automatically injected into your Vercel projects when you create
                a resource.
              </p>
            </div>
