...
export const GET = withAuth(async (claims) => {
  try {
    ...
    for (const installationId of installationIds) {
      ...
      if (installationUserId !== claims.user_id && installationTeamId !== claims.team_id) {
        continue;
      }
      ...
      try {
        ...
        console.error(`[Configurations] Failed to get account info for ${installationId}:`, error);
      }
    }
